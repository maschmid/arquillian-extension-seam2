...
import org.jboss.arquillian.seam2.test.event.ConversionEmitter;
import org.jboss.arquillian.seam2.test.event.ConversionResultHolder;
import org.jboss.arquillian.seam2.test.event.Event;
...
{
   @Deployment(name="ComponentNamedInjectionTestCase")
   ...
   public void shouldConvertFluidOuncesToMillilitres() throws Exception
   {
      ...
      // when
      emitter.convertToMilliliters(ouncesToConver);

      // then
      assertThat(holder.getMilliliters()).isEqualTo(expectedMillilitres);
   }
