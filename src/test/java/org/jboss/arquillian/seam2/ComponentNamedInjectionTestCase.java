...
import org.jboss.arquillian.seam2.test.simple.ConverterFactory;
...
public class ComponentNamedInjectionTestCase
{
   ...
   @Test
   public void shouldInjectNamedSeamComponent() throws Exception
   {
      assertThat(fluidOuncesConverter).isNotNull();
      assertThat(fluidOuncesConverter.getIdentifier()).isEqualTo("created-by-factory");
   }
